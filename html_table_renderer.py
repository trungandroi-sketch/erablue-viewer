...
COLUMN_GROUPS = [
    ...
    },
    {
        ...
        "cols": ["Samsung Bàn Demo", "Samsung Tủ Tường Thương hiệu"],
    },
    {
        "label": "Apple", "emoji": "🍎",
        "color": "#3a3a3c", "text": "#ffffff",
        "cols": ["Apple 1.2m Bàn Demo", "Apple 1.2m Tủ Tường Thương hiệu"],
    },
    {
        "label": "OPPO", "emoji": "📱",
        "color": "#1a7c40", "text": "#ffffff",
        "cols": ["OPPO Bàn Demo", "OPPO Tủ Tường Thương hiệu"],
    },
    {
        "label": "Xiaomi", "emoji": "📱",
        "color": "#e05c00", "text": "#ffffff",
        "cols": ["Xiaomi Bàn Demo", "Xiaomi Tủ Tường Thương hiệu"],
    },
    {
        "label": "Vivo", "emoji": "📱",
        "color": "#3251ff", "text": "#ffffff",
        "cols": ["Vivo Bàn Demo", "Vivo Tủ Tường Thương hiệu"],
    },
    {
        "label": "Realme", "emoji": "📱",
    ...
    },
    {
        ...
        "cols": [
            ...
            "Diện tích (m2) WC + Phòng Nhân viên", "Diện tích (m2) Kho + Server",
            "Diện tích (m2) Bãi đậu xe", "Diện tích (m2) Showroom",
            "Diện tích (m2) Tổng diện tích", "Diện tích (m2) Đất trống",
        ],
    },
    {
...
def _short(col: str) -> str:
    ...
    STRIP = [
        "Samsung ", "Apple 1.2m ", "OPPO ", "Xiaomi ", "Vivo ", "Realme ", "Infinix ",
        "Tài nguyên cho Erablue Electronics ",
        "Tài nguyên Layout (total Principle) ",
        "Tài nguyên Thực tế (total Principle) ",
        "Vách Tivi principle (Vị trí ưu tiên) ",
        "TV đảo principle (Nguyên tắc) (/Kệ) ",
        "Máy lạnh principle (SL) ",
        "Tủ lạnh principle (/Kệ) ",
        "Máy Giặt principle ",
        "SDA ", "POSTER TƯỜNG ",
        "Diện tích (m2) ",
        "Bàn ", "Tủ Điện thoại ", "Mặt tiền ",
    ]
    for prefix in STRIP:
